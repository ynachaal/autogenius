...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        DB::table('email_templates')->updateOrInsert(
            ['title' => 'Service Insurance Claim - Admin'], // unique key
            [
                'subject' => 'New Service Insurance Claim Request - autogenius',
...
<h2 style="margin: 0; font-size: 24px; font-weight: bold;">New Insurance Claim Request</h2>
</td>
</tr>
...
<p style="margin: 0 0 15px 0;">A new <strong>Service Insurance Claim</strong> has been submitted. Details are provided below:</p>
...
<tr>
<td style="padding: 8px; font-weight: bold; background-color: #f9fafb; border: 1px solid #eeeeee;">Service Type</td>
...
<tr>
<td style="padding: 8px; font-weight: bold; background-color: #f9fafb; border: 1px solid #eeeeee;">Submitted At</td>
<td style="padding: 8px; border: 1px solid #eeeeee;">{{date}}</td>
</tr>
</table>

<p style="margin: 15px 0 0 0;">Please log into the admin panel to review the attached <strong>RC</strong> and <strong>Insurance</strong> documents.</p>
</td>
</tr>
...
<p style="margin: 0;">© ' . $now->year . ' autogenius</p>
    ...
    public function down(): void
    {
        DB::table('email_templates')
            ->where('title', 'Service Insurance Claim - Admin')
            ->delete();
    }
};
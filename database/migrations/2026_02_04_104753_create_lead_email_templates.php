...
return new class extends Migration {
    ...
    public function down(): void
    {
        DB::table('email_templates')
            ->whereIn('title', ['Lead Inquiry Confirmation - User', 'New Lead Alert - Admin'])
            ->delete();
    }
...
<p style="margin: 0 0 15px 0;">Our team is currently reviewing your preferences regarding <strong>{{fuel_preference}} {{body_type}}</strong> options. We will contact you shortly via <strong>{{preferred_contact_method}}</strong>.</p>

    ...
    <div class="contact-form">
        ...
        <form id="carForm" action="{{ route('lead.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input value="{{ old('mobile') }}" required placeholder="Mobile Number" name="mobile"
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="contact" value="Call" id="Call" {{ old('contact') == 'Call' ? 'checked' : '' }}>
            ...
            <div class="step" data-step="3">
                ...
                <div class="form-group mb-4">
                    <p class="fw-normal">Primary Usage <span class="text-danger">*</span></p>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="usage" id="city1" value="City" required {{ old('usage', 'City') == 'City' ? 'checked' : '' }}>
                        <label class="form-check-label" for="city1">City </label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="usage" value="Highway" id="highway" {{ old('usage') == 'Highway' ? 'checked' : '' }}>
                        <label class="form-check-label" for="highway">Highway </label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="usage" value="Mixed" id="mixed" {{ old('usage') == 'Mixed' ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="running_pattern" value="Everyday" id="daily"
                            required {{ old('running_pattern', 'Everyday') == 'Everyday' ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="running_pattern" value="Monthly" id="monthly"
                            {{ old('running_pattern') == 'Monthly' ? 'checked' : '' }}>
                        <label class="form-check-label" for="monthly">Monthly</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="running_pattern" value="Yearly" id="yearly"
                            {{ old('running_pattern') == 'Yearly' ? 'checked' : '' }}>
                        <label class="form-check-label" for="yearly">Yearly</label>
                    </div>
                </div>
                <div class="form-group mb-4">
                    <label for="running_km" class="form-label">Approx KM</label>
                    <input type="number" name="running_km" id="running_km" placeholder="km/day / km/month / km/year"
                        class="form-control" value="{{ old('running_km') }}">
                </div>
                <div class="form-group mb-4">
                    <p class="form-label">No. of Passengers Usually</p>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="passengers_usually" value="1-2" id="1-2" {{ old('passengers_usually', '1-2') == '1-2' ? 'checked' : '' }}>
                        <label class="form-check-label" for="1-2">1-2</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="passengers_usually" value="3–4" id="3–4" {{ old('passengers_usually') == '3–4' ? 'checked' : '' }}>
                        <label class="form-check-label" for="3–4">3–4</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="passengers_usually" value="5+" id="5+" {{ old('passengers_usually') == '5+' ? 'checked' : '' }}>
            ...
            <div class="step" data-step="4">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="body_type[]" value="Hatchback"
                            id="Hatchback" {{ (is_array(old('body_type')) && in_array('Hatchback', old('body_type'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="Hatchback">Hatchback</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="body_type[]" value="Sedan" id="Sedan" {{ (is_array(old('body_type')) && in_array('Sedan', old('body_type'))) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="body_type[]" value="Compact SUV"
                            id="compact_suv" {{ (is_array(old('body_type')) && in_array('Compact SUV', old('body_type'))) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="body_type[]" value="SUV / MUV"
                            id="suv_muv" {{ (is_array(old('body_type')) && in_array('SUV / MUV', old('body_type'))) ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="fuel[]" value="Petrol" id="Petrol" {{ (is_array(old('fuel')) && in_array('Petrol', old('fuel'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="Petrol">Petrol</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="fuel[]" value="Diesel" id="Diesel" {{ (is_array(old('fuel')) && in_array('Diesel', old('fuel'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="Diesel">Diesel</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="fuel[]" value="CNG" id="CNG" {{ (is_array(old('fuel')) && in_array('CNG', old('fuel'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="CNG">CNG</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="fuel[]" value="Electric" id="Electric" {{ (is_array(old('fuel')) && in_array('Electric', old('fuel'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="Electric">Electric</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="fuel[]" value="Hybrid" id="Hybrid" {{ (is_array(old('fuel')) && in_array('Hybrid', old('fuel'))) ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gearbox_preference" value="Manual"
                            id="Manual" {{ old('gearbox_preference') == 'Manual' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Manual">Manual</label>
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gearbox_preference" value="Automatic"
                            id="Automatic" {{ old('gearbox_preference') == 'Automatic' ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="comfort_priority" value="Balanced"
                            id="Balanced" {{ old('comfort_priority') == 'Balanced' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Balanced">Balanced</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="comfort_priority" value="Performance"
                            id="Performance" {{ old('comfort_priority') == 'Performance' ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="feature_priority[]" value="Safety"
                            id="Safety" {{ (is_array(old('feature_priority')) && in_array('Safety', old('feature_priority'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="Safety">Safety</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="feature_priority[]" value="Comfort"
                            id="ComfortFeature" {{ (is_array(old('feature_priority')) && in_array('Comfort', old('feature_priority'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="ComfortFeature">Comfort</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="feature_priority[]" value="Technology"
                            id="Technology" {{ (is_array(old('feature_priority')) && in_array('Technology', old('feature_priority'))) ? 'checked' : '' }}>
                        <label class="form-check-label" for="Technology">Technology</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="feature_priority[]" value="Performance"
                            id="PerformanceFeature" {{ (is_array(old('feature_priority')) && in_array('Performance', old('feature_priority'))) ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="noise_sensitivity" value="Important"
                            id="Important" {{ old('noise_sensitivity') == 'Important' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Important">Important</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="noise_sensitivity" value="Not Important"
                            id="Not-Important" {{ old('noise_sensitivity') == 'Not Important' ? 'checked' : '' }}>
            ...
            <div class="step" data-step="5" id="preOwnedStep">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="max_acceptable" value="1st Owner" id="m1" {{ old('max_acceptable') == '1st Owner' ? 'checked' : '' }}>
                        <label class="form-check-label" for="m1">1st Owner</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="max_acceptable" value="2nd Owner" id="m2" {{ old('max_acceptable') == '2nd Owner' ? 'checked' : '' }}>
                        <label class="form-check-label" for="m2">2nd Owner</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="max_acceptable" value="Any" id="any" {{ old('max_acceptable') == 'Any' ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="History" value="Zero Tolerance" id="zero" {{ old('History') == 'Zero Tolerance' ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Preference" value="Comprehensive"
                            id="Comprehensive" {{ old('Preference') == 'Comprehensive' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Comprehensive">Comprehensive</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Preference" value="Third-party"
                            id="Third-party" {{ old('Preference') == 'Third-party' ? 'checked' : '' }}>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Purchase" value="Immediate (0–7 days)"
                            id="Immediate" {{ old('Purchase') == 'Immediate (0–7 days)' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Immediate">Immediate (0–7 days)</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Purchase" value="2–4 weeks" id="weeks" {{ old('Purchase') == '2–4 weeksweeks' ? 'checked' : '' }}>
                        <label class="form-check-label" for="weeks">2–4 weeks</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Purchase" value="1–3 months" id="months" {{ old('Purchase') == '1–3 months' ? 'checked' : '' }}>
            ...
            <div class="step" data-step="6">
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Decision" value="Self" id="Self" {{ old('Decision', 'Self') == 'Self' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Self">Self</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Decision" value="Family" id="Family" {{ old('Decision') == 'Family' ? 'checked' : '' }}>
                        <label class="form-check-label" for="Family">Family</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="Decision" value="Company" id="Company" {{ old('Decision') == 'Company' ? 'checked' : '' }}>

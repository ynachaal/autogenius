<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <h2 class="h4">{{ __('Menu Categories') }}</h2>
                                ...
                                <tr>
                                    ...
                                    @php
                                        ...
                                        $sort = function ($column, $label) use ($sortBy, $sortDirection) {
                                            ...
                                            return '<a class="text-decoration-none text-dark fw-semibold" href="' . route('admin.menu-categories.index', $query) . '">' . $label . ' ' . $icon . '</a>';
                            ...
                            <tbody>
                                ...
                                @empty
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="6" class="text-center">No menu categories found.</td>

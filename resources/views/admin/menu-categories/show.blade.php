                ...
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex gap-2">
                        ...
                        <a href="{{ route('admin.menu_categories.edit', $menuCategory) }}"
                            class="btn btn-sm btn-primary" data-toggle="tooltip" title="Edit Menu Category">

                            <i class="bi bi-pencil me-1"></i> Edit

                        </a>

                        <form action="{{ route('admin.menu_categories.destroy', $menuCategory) }}" method="POST"
                            class="d-inline" id="delete-form-{{ $menuCategory->id }}">
                        ...
                        <a href="{{ route('admin.menu_categories.index') }}" class="btn btn-sm btn-secondary"
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="text-muted mb-2">
                                ...
                                <strong>Description:</strong> <span
                                    class="fw-semibold">{{ $menuCategory->description ?: '-' }}</span>

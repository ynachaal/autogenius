                ...
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex gap-2">
                        ...
                        <a href="{{ route('admin.faqs.edit', $faq) }}" class="btn btn-sm btn-primary"
                            data-toggle="tooltip" title="Edit FAQ">
                        ...
                        <form action="{{ route('admin.faqs.destroy', $faq) }}" method="POST" class="d-inline"
                            ...
                            <button type="submit" class="btn btn-sm btn-danger" data-toggle="tooltip" title="Delete FAQ"
                        ...
                        <a href="{{ route('admin.faqs.index') }}" class="btn btn-sm btn-secondary" data-toggle="tooltip"
                            title="Back to List">

                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-4">
                            ...
                            @if($slider->type == 'image')
                                <img src="{{ asset('storage/' . $slider->file) }}"
                                    class="img-fluid rounded border shadow-sm w-100" alt="Slider Image"
                        ...
                        <div class="col-md-7">
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <small class="text-uppercase text-muted fw-bold d-block">Order</small>
                                    <span class="fs-6">{{ $slider->order ?? 0 }}</span>
                                </div>
                                <div class="col-sm-6 mb-3">
                    ...
                    @if($slider->deleted_at)
                        <div class="alert alert-warning mt-3 mb-0">
                            ...
                            This record was soft-deleted on
                            <strong>{{ $slider->deleted_at->format('M d, Y H:i') }}</strong>.
                        </div>
                    @endif
                </div>

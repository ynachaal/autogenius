                ...
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex gap-2">
                        ...
                        <a href="{{ route('admin.menus.edit', $menu) }}" class="btn btn-sm btn-primary"
                            data-toggle="tooltip" title="Edit Menu">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="text-muted mb-2">
                                ...
                                <strong>Parent:</strong> <span
                                    class="fw-semibold">{{ $menu->parent ? $menu->parent->title : '-' }}</span>
                            ...
                            <p class="text-muted mb-2">
                                ...
                                <strong>Category:</strong> <span
                                    class="fw-semibold">{{ $menu->category ? $menu->category->name : '-' }}</span>
                            ...
                            <p class="text-muted mb-2">
                                ...
                                <strong>Active:</strong> <span
                                    class="fw-semibold">{{ $menu->is_active ? 'Yes' : 'No' }}</span>

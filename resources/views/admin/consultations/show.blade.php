                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-end">
                            ...
                            <p>
                                ...
                                <span
                                    class="badge {{ $consultation->status == 'pending' ? 'bg-warning text-dark' : ($consultation->status == 'completed' ? 'bg-success' : 'bg-danger') }}">
                    ...
                    <div class="bg-light p-4 border rounded">
                        ...
                        <p class="text-dark" style="white-space: pre-wrap;">
                            {{ $consultation->message ?? 'No additional details provided.' }}</p>
                    </div>
                </div>
                <div class="card-footer">
                    <a href="mailto:{{ $consultation->email }}?subject=Re: Consultation - {{ $consultation->subject }}"

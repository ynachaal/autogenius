    ...
    <div class="payment-card">
        <div id="payment-status-container">
            <div id="loading-ui">
                ...
                <h3 class="fw-bold">Securing Your Booking</h3>
        ...
        <form id="razorpay-form" action="{{ route('service-insurance.payment.verify') }}" method="POST">
            @csrf
    ...
    <script>
        const options = {
            ...
            handler: function (response) {
                ...
                <p class="text-muted">Transaction successful! Confirming your request...</p>
            `;
            ...
            prefill: {
                // Changed variables from $inspection to $insurance
                name: "{{ $insurance->customer_name }}",
                contact: "{{ $insurance->customer_mobile }}",

...
<head>
    ...
    <title>Payment Failed - AutoGenius</title>
    ...
    <style>
        ...
        .error-card { background: white; padding: 40px; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.05); max-width: 450px; width: 90%; text-align: center; }
...
<div class="error-card">
    ...
    <div class="d-grid gap-2 mt-4">
        ...
        <a href="{{ route('lead.index') }}" class="btn btn-primary btn-lg">Try Again</a>
